...
var HTMLskillsStart = '<h3 class="skills-h3">Skills at a Glance:</h3><ul id="skills" class="flex-column"></ul>';
...
var HTMLonlineURL = '<br><a class="orange" href="#">%data%</a>';
...
$(document).click(function(loc) {
  var x = loc.pageX;
  // pageX is the pixel value of the X location
  // of the click
  var y = loc.pageY;
...
function initializeMap() {
  ...
  */
  function locationFinder() {
    ...
    // a return statement makes a function give back a value
    return locations;
  }
